...
- a group can have its trackers drawn by the game: each tracker gets a Blizzard aura slot filtered to its spell, shown by the game while the aura is on you (in combat too) and hidden otherwise, uncovering the addon's "missing" art underneath; the game allows this for buffs on you and debuffs on your target, not debuffs on you
