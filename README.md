...
- **Edit layout**, beside the search box, puts the window out of the way and lets you arrange the trackers: drag them where you want them, click one to open its settings. A bar across the top says so and has a Done button, which brings the window back.
